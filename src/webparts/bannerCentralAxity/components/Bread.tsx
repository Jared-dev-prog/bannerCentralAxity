...
import {
  IBreadcrumbs,
  ICollectionBreadcrumbs,
} from "./IBannerCentralAxityProps";
import styles from "./BannerCentralAxity.module.scss";

const Bread: React.FC<ICollectionBreadcrumbs> = (props) => {
  const { breadcrumbs } = props;
  const handleRedirect = (breadcrumbs: IBreadcrumbs): void => {
    if (breadcrumbs.url) window.open(breadcrumbs.url, "_self");
  };
  return (
